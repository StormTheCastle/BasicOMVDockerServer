...
3. Storage > Shared Folders will be where you create the folder system of data. Docker follows an expected pattern so we will do this later in the [Docker steps](OpenMediaVault/Docker/README.md)
